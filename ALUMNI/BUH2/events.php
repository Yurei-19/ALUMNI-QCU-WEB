    ...
    <body>
        ...
        <nav>
            <div class="nav">
                ...
                <div class="nav-button" style="background: linear-gradient(95deg, rgba(0, 0, 0, 0.76), rgb(99, 99, 235));"><img src="events-icon.png" style="filter: brightness(0) invert(1);"/> <a href="events.php" style="color: white;"><li>Events</li></a></div>
