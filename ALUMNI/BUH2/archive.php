    ...
    <nav>
        <div class="nav">
            <ul>
                ...
                <div class="nav-button"><img src="checkmark.png "/><a href="approval.php">Approval</a></div>
                <div class="nav-button" style="background: linear-gradient(95deg, rgba(0, 0, 0, 0.76), rgb(99, 99, 235));">
                    <img src="crossmark.png" style="filter: brightness(0) invert(1);"/> <a href="archive.php"
                                                                                            style="color: white;"><li>Archive</li></a></div>
...
<h1 class="approval-request-h1">Declined Request</h1>
<div class="search-container">
    
    <input type="text" id="searchInput" placeholder="Search by name">
    <button class="search-button" onclick="searchAlumni()">
...
<div class="approval-container">
    <div class="left-side-approval">
        <div class="scrollable1">
            ...
            $sql = "SELECT * FROM REJECT_ALUMNI_LIST";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                // Output data of each row
                while ($row = $result->fetch_assoc()) {
                    echo "<div class='clickable-div' onclick='toggleDisplayArchive(" . $row["add_id"] . ")'>";
