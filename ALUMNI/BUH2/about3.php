        ...
        <nav>
            <div class="nav">
                ...
                <div class="nav-button"><img src="home.png"/> <a href="index3.php"><li>Home</li></a></div>
                    ...
                    <div class="nav-button" style="background: linear-gradient(95deg, rgba(0, 0, 0, 0.76), rgb(99, 99, 235));"><img src="about-icon.png" style="filter: brightness(0) invert(1);"/> <a href="about3.php" style="color: white;"><li>About</li></a></div>
